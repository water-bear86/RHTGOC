...
import royalStorehousePackage from "../missions/royal-storehouse.v1.json"
...
export const ROYAL_STOREHOUSE_MISSION = parseMissionDefinition(royalStorehousePackage)
export const MISSION_CATALOG: ReadonlyMap<string, MissionDefinition> = new Map([
  ...
  [ROYAL_STOREHOUSE_MISSION.slug, ROYAL_STOREHOUSE_MISSION],
])
