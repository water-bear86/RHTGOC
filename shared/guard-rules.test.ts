...
describe("shared guard rules", () => {
  ...
  it("publishes generous, role-readable incapacitation windows", () => {
    expect(SHERWOOD_ARROW_INCAPACITATION_SECONDS).toBe(10)
    expect(SHERWOOD_VOLLEY_INCAPACITATION_SECONDS).toBe(12)
    expect(SHERWOOD_SWEEP_INCAPACITATION_SECONDS).toBe(14)
    expect(SHERWOOD_SNARE_INCAPACITATION_SECONDS).toBe(15)
