...
export interface MultiplayerEvents {
  ...
  onSnapshot?: (tick: number, players: Array<Pick<RoomPlayer, "id" | "position" | "lastInputSequence" | "arrows" | "loot" | "captureFor" | "bowCooldown" | "signatureCooldown" | "protectionScore" | "crowdControl" | "heavyCarryPeak" | "trapHits" | "sabotageCount" | "stealth" | "bowAction">>, mission: MissionSnapshot) => void
