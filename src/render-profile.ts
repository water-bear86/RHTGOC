...
export function chooseRenderProfile(capabilities: RenderCapabilities): RenderProfile {
  const degraded = capabilities.maxTextureSize < 4096 || capabilities.maxTextures < 16
  return {
