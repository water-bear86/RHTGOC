# Sherwood, the game (on robinhood chain) — Product Requirements Document
...
Sherwood, the game (on robinhood chain) — repo slug RHTGOC — is a social 3D browser adventure in which players form outlaw bands, rob the Sheriff, escape through a living Sherwood, and return stolen wealth to communities that visibly change because of their choices.
